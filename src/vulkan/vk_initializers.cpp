...
VkCommandPoolCreateInfo vkinit::command_pool_create_info(u32 queueFamilyIndex, VkCommandPoolCreateFlags flags) {
...
VkCommandBufferAllocateInfo vkinit::command_buffer_allocate_info(VkCommandPool pool, u32 count) {
